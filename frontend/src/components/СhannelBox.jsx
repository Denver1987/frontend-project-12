...
import {
  setCurrentChannel, setOnRemoveChannel, setOnRenameChannel, resetSuccess,
} from '../store/slices/channels.js';
...
const BuildChannelBox = () => {
  ...
  return (
    <ul id="channels-box" ref={channelBoxRef} className="nav flex-column nav-pills nav-fill px-2 mb-3 overflow-auto h-100 d-block">
